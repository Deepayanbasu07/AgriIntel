		...
		<div className="min-h-screen bg-gradient-to-br from-[var(--agri-green-50)] to-green-100">
			<div className="max-w-6xl mx-auto px-4 py-8">
				...
				<div className="text-center mb-8">
					<h1 className="text-4xl font-bold text-gray-900 mb-4 break-words whitespace-pre-wrap">
						{t.market.title}
					</h1>
					<p className="text-xl text-gray-600">{t.market.subtitle}</p>
				</div>
				...
				<div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
					<Card className="bg-gradient-to-br from-green-50 to-green-100">
						<CardContent className="p-6 text-center">
							...
							<p className="text-2xl font-bold text-[var(--agri-primary)]">
								{crops.length}
							</p>
					...
					<Card className="bg-gradient-to-br from-orange-50 to-orange-100">
						<CardContent className="p-6 text-center">
							...
							<p className="text-2xl font-bold text-[var(--price-amber)]">
								{states.length}
							</p>
